...
import { maxwidth, PostFeed, PostFeedRaise, SiteMain } from "../styles/shared";
...
const IndexPage: React.FC<IndexProps> = (props) => {
  ...
  const FiltersPostCard = (post: any) => {
    return (
  ...
  const CreatePostCard = (start: number, end: number, layers: any) => {
  ...
  return (
    <IndexLayout css={HomePosts}>
      ...
      <Wrapper>
        <SiteNav isBlog />
        <main id="site-main" css={[SiteMain, maxwidth]}>
          <div>
            <div css={[PostFeed, PostFeedRaise]}>
              {CreatePostCard(0, 6, "first")}
            </div>
          </div>
        </main>
        <Pagination
