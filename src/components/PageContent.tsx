...
const PageFullContent = styled.section`
  position: relative;
  margin: 0 auto;
  padding: 70px 100px;
  min-height: 230px;
...
const PageContent: React.FC<PageContentProps> = ({ htmlAst }) => {
  return (
    <PageFullContent className="post-full-content">
